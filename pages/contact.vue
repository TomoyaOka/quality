  ...
  <div class="form ff-n">
     <div class="form__item">
      ...
      <select name="" id="">
        ...
        <option value="">ホームページ制作について</option>
        <option value="">コーディングについて</option>
        <option value="">その他</option>
      </select>
      <span class="form__item-error">※必須項目を入力してください</span>
    </div>
    <div class="form__item">
      <label for="">会社名</label>
      <input type="text" placeholder="クオリティ ウェブ スタジオ" >
    </div>

    <div class="form__item">
      <label for="">担当者名<span>必須</span></label>
      <input type="text" placeholder="オカダトモヤ" >
      <span class="form__item-error">※必須項目を入力してください</span>
    </div>

    <div class="form__item">
      <label for="">メールアドレス<span>必須</span></label>
      <input type="text" placeholder="design@xxx.com" >
      <span class="form__item-error">※必須項目を入力してください</span>
    </div>

    <label for="">お問い合わせ内容<span>必須</span></label>
    <textarea name="" id="" cols="30" rows="10" placeholder="例)ホームページ制作をしたいのですが、見積もりをお願いできますか？"></textarea>
      <span class="form__item-error">※必須項目を入力してください</span>
    <button type="submit" class="submit">確認する</button>
  </div>
    </section>
</div>
<!-- /form -->
